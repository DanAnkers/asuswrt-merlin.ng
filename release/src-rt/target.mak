...
DSL-AC68U-NONE := LOGO_LED=y LED_BTN=y
...
export DSL-AC68U += PC_SCHED_V3=n OPEN_NAT=y
...
export GT-AC2900 += BUILD_NAME="GT-AC2900" NVSIZE="128" DHDAP=y DPSTA=y LACP=y WTFAST=y REPEATER=y \
				...
				IPSEC=STRONGSWAN IPSEC_SRVCLI_ONLY=SRV ALEXA=y IFTTT=y VPN_FUSION=n IPV6S46=y\
...
export RT-AX58U += BUILD_NAME="RT-AX58U" NVSIZE="128" DHDAP=y HND_WL=y DPSTA=y LACP=n WTFAST=n REPEATER=y SW_CTRL_ALLLED=y \
		...
		ACL96=y IPV6S46=y GOOGLE_ASST=y \
		NFS=y SNMPD=n TOR=y UPNPIGD2=n NANO=y OPENSSL11=y NTPD=y
...
export RT-AX56U += BUILD_NAME="RT-AX56U" SWITCH2="BCM53134" NVSIZE="128" DHDAP=y HND_WL=y DPSTA=y LACP=n WTFAST=n REPEATER=y SW_CTRL_ALLLED=y \
		...
		ACL96=y IPV6S46=y GOOGLE_ASST=y ASUSCTRL=y \
		NFS=y SNMPD=n TOR=y UPNPIGD2=n NANO=y OPENSSL11=y NTPD=y
...
export RT-AX86U += BUILD_NAME="RT-AX86U" EXT_PHY="BCM84880" NVSIZE="128" DHDAP=y HND_WL=y \
		...
		ACL96=y GOOGLE_ASST=y EXTEND_LIMIT=y ASUSCTRL=y \
...
export DSL-AX82U += BUILD_NAME="DSL-AX82U" NVSIZE="128" DHDAP=y HND_WL=y DPSTA=y LACP=n WTFAST=n REPEATER=y \
		...
		ACCEL_PPTPD=y PRINTER=y WEBDAV=y SMARTSYNCBASE=y USB="USB" APP="installed" PROXYSTA=y DNSMQ=y SHP=n \
		...
		HFS="tuxera" NEWSSID_REV2=y NEWSSID_REV4=y LAN4WAN_LED=n NEW_APP_ARM=y VISUALIZATION=y BONDING=n \
		BONDING_WAN=n NETOOL=y TRACEROUTE=y FORCE_AUTO_UPGRADE=y ALEXA=y IFTTT=y SW_HW_AUTH=y HD_SPINDOWN=y \
...
export DSL-AX82U += DISABLE_REPEATER_UI=y OOKLA=y WL_SCHED_V3=y TR069=n BCM_OAM=y TR181=n MTWANCFG=y
